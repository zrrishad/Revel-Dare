...
public class CupleActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cuple4);
        ...
        RequestQueue queue = Volley.newRequestQueue(CupleActivity4.this);
        String url = "http://192.168.1.107/apps/load%20server%20cupple.four";
