...
public class CupleActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cuple1);
        ...
        RequestQueue queue = Volley.newRequestQueue(CupleActivity1.this);
        String url = "http://192.168.0.123/apps/load%20server%20cupple.one";
